...
function calculateTrajectory(
  ...
  for (let distance = 0; distance <= maxRange; distance += 10) {
    ...
    while (x < targetDistanceM && time < 10) {
      // 10s timeout
  ...
  const handleExportData = () => {
    ...
    if (!trajectoryData || trajectoryData.length === 0) {
      toast({
        ...
        description: "Trajectory data is empty.",
        variant: "destructive",
      });
      return;
    }

    const ws = XLSX.utils.json_to_sheet(trajectoryData);
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "Trajectory");

    const exportFileName = `ballistics_${selectedBulletType}_${zeroRange}yd.xlsx`;
                    ...
                    <div className="space-y-3 border border-primary/20 p-3 rounded-md">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="col-span-2 space-y-1">
                          <Label htmlFor="bc" className="text-xs">
                        ...
                        <div className="col-span-2 space-y-1">
                          <Label htmlFor="muzzleVelocity" className="text-xs">
                            Muzzle Velocity (fps)
                          </Label>
                          <Input
                            id="muzzleVelocity"
                ...
                <CardContent>
                  <Tabs defaultValue="drop">
                    <TabsList className="w-full mb-4">
                      ...
                      <TabsTrigger value="windage" className="flex-1">
                        Windage
                      </TabsTrigger>
                    </TabsList>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            ...
                            <ReferenceLine
                              ...
                              stroke="#66bb6a"
                              strokeDasharray="3 3"
                              label="Upper Vital Zone"
                            />
                            <ReferenceLine
                              y={-3}
                              stroke="#f44336"
                              strokeDasharray="3 3"
                              label="Lower Vital Zone"
                            />
                            <Line
                              type="monotone"
                              dataKey="drop"
                  ...
                  {/* <Button
                    ...
                    onClick={() => {
                      ...
                      navigator.clipboard.writeText(
                        `${window.location.origin}${basePath}/ballistics?${params.toString()}`
                      );
